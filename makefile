...
OBJECTS = $(MATH_DIR_OBJ:.cc=.o) $(OTHER_OBJ:.cc=.o) $(GRAPHICS_DIR_OBJ:.cc=.o) $(SHADER_DIR_OBJ:.cc=.o) $(GRAPHICS_ASSET_DIR_OBJ:.cc=.o) $(APPLICATION_DIR_OBJ:.cc=.o) $(COLLISION_DIR_OBJ:.cc=.o) main.o application.o rocket.o
DEPENDS = ${OBJECTS:.o=.d}
